...
inline constexpr char MIX_OVER_ROUNDS[] = "Shot mix over %u rounds";
inline constexpr char MIX_NEED_ROUNDS[] = "Shot mix needs two tracked rounds. Found %u.";
...
inline constexpr char SCORECARD[] = "Scorecard";
inline constexpr char HOLE_BY_HOLE[] = "Hole by hole";
inline constexpr char STATISTICS[] = "Statistics";
inline constexpr char CHEVRON[] = ">";
inline constexpr char ROUND_INFO_HOLES_FORMAT[] = "%u holes · %s tees";
inline constexpr char ROUND_INFO_STATS_FORMAT[] = "%u putts · %u penalty strokes";
...
inline constexpr char WHERE_SHOTS_WENT[] = "WHERE THE SHOTS WENT";
inline constexpr char TOTAL_PENALTIES[] = "Total penalties";
inline constexpr char HAZARDS[] = "Hazards";
inline constexpr char OUT_OF_BOUNDS[] = "Out of bounds";
...
inline constexpr char DELETE_ROUND[] = "Delete round";
inline constexpr char DELETE_DATED_PROMPT[] = "Permanently delete %s — %s?";
inline constexpr char DELETE_UNDATED_PROMPT[] = "Permanently delete %s?";
inline constexpr char DELETE_ERROR[] = "Delete failed. The round is still in History.";
...
inline constexpr char O_TAG[] = "O";
inline constexpr char SCORING_ZONE[] = "SCORING ZONE";
